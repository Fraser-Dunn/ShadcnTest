  ...
  return (
    <>
      <div className="grid h-screen bg-background grid-rows-[auto_1fr] grid-cols-[7fr_6fr] ">
        ...
        <div className="h-[70%] col-start-1 col-end-2 row-start-2 row-end-2 text-center border-r-1 border-muted flex items-center justify-center">
          <div className="h-11/12 w-11/12 border-1 border-muted flex items-center justify-center"></div>
        </div>

        <div className="h-[70%] col-start-2 col-end-3 row-start-2 row-end-2 text-center border-r-1 border-muted flex items-center justify-center">
